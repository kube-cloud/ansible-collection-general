...
DOCUMENTATION = '''
---
module: alm_settings_azure
version_added: "1.0.0"
short_description: Manage ALM AlmSettingsAzure for Azure
description:
  - Used toManage Sonarqube ALM AlmSettingsAzure for Azure
  - Create, Update and Delete Sonarqube ALM AlmSettingsAzure for Azure
requirements:
  - requests
...
options:
  ...
  url:
    description:
      - The SonarQube Setting Azure url
    required: true
    type: str
...
- name: "Create SonarQube ALM Setting Azure"
  kube_cloud.general.sonarqube.alm_settings_azure:
    ...
    key: "demo-settings-azure"
    url: 'https://dev.azure.com'
    personal_access_token: 'test-azure-pat'
    state: 'present'
'''

from ansible.module_utils.basic import AnsibleModule
from ...module_utils.sonarqube.client import AlmSettingsAzureClient, sonarqube_client
...
# Find and Return AlmSettingsAzure
def get_setting(client: AlmSettingsAzureClient, key: str):
...
def update_setting(
    ...
    client: AlmSettingsAzureClient,
    setting: AlmSettingsAzure,
...
# Delete Setting
def delete_setting(module: AnsibleModule, client: AlmSettingsAzureClient, key: str):
...
def build_requested_setting(params: dict) -> AlmSettingsAzure:
...
def run_module(module: AnsibleModule, client: AlmSettingsAzureClient):
...
def main():
    ...
    # Build Client from Module
    client = build_client(module).alm_settings_azure
