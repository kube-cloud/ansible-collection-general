...
DOCUMENTATION = '''
---
module: alm_settings_bitbucket_cloud
version_added: "1.0.0"
short_description: Manage ALM AlmSettingsBitbucketCloud for BitbucketCloud
description:
  - Used toManage Sonarqube ALM AlmSettingsBitbucketCloud for BitbucketCloud
  - Create, Update and Delete Sonarqube ALM AlmSettingsBitbucketCloud for BitbucketCloud
requirements:
  - requests
...
options:
  ...
  client_id:
    description:
      - The SonarQube Setting Client ID
    required: true
    type: str
  client_secret:
    description:
      - The SonarQube Setting Client Secret
    required: true
    type: str
  workspace:
    description:
      - The SonarQube Setting Workspace
    required: true
    type: str
  encode_parameters:
    description:
...
EXAMPLES = r'''
- name: "Create SonarQube ALM Setting BitbucketCloud"
  kube_cloud.general.sonarqube.alm_settings_bitbucket_cloud:
    base_url: "http://localhost:9000"
    username: "admin"
    password: "admin"
    component: "my_project"
    key: "demo-settings-bitbucket_cloud"
    client_id: 'bitbucket_cloud-app-client-id'
    client_secret: 'bitbucket_cloud-app-client-secret'
    workspace: 'myWorkspace'
    state: 'present'
'''

from ansible.module_utils.basic import AnsibleModule
from ...module_utils.sonarqube.client import AlmSettingsBitbucketCloudClient, sonarqube_client
...
# Find and Return AlmSettingsBitbucketCloud
def get_setting(client: AlmSettingsBitbucketCloudClient, key: str):
...
def update_setting(
    ...
    client: AlmSettingsBitbucketCloudClient,
    setting: AlmSettingsBitbucketCloud,
...
# Delete Setting
def delete_setting(module: AnsibleModule, client: AlmSettingsBitbucketCloudClient, key: str):
...
def build_requested_setting(params: dict) -> AlmSettingsBitbucketCloud:

    # Base Parameters Name
    base_param_names = [
        "key", "new_key", "client_id", "client_secret", "workspace"
    ]
...
def run_module(module: AnsibleModule, client: AlmSettingsBitbucketCloudClient):
...
def main():
    ...
    # Build Client from Module
    client = build_client(module).alm_settings_bitbucket_cloud
