...
DOCUMENTATION = '''
---
module: alm_settings_gitlab
version_added: "1.0.0"
short_description: Manage ALM AlmSettingsGitlab for Gitlab
description:
  - Used toManage Sonarqube ALM AlmSettingsGitlab for Gitlab
  - Create, Update and Delete Sonarqube ALM AlmSettingsGitlab for Gitlab
requirements:
  - requests
...
options:
  ...
  url:
    description:
      - The SonarQube Setting Gitlab url
    required: true
    type: str
...
EXAMPLES = r'''
- name: "Create SonarQube ALM Setting Gitlab"
  kube_cloud.general.sonarqube.alm_settings_gitlab:
    base_url: "http://localhost:9000"
    username: "admin"
    password: "admin"
    component: "my_project"
    key: "demo-settings-gitlab"
    url: 'https://api.gitlab.com'
    personal_access_token: 'test-gitlab-pat'
    state: 'present'
'''

from ansible.module_utils.basic import AnsibleModule
from ...module_utils.sonarqube.client import AlmSettingsGitlabClient, sonarqube_client
...
# Find and Return AlmSettingsGitlab
def get_setting(client: AlmSettingsGitlabClient, key: str):
...
def update_setting(
    ...
    client: AlmSettingsGitlabClient,
    setting: AlmSettingsGitlab,
...
# Delete Setting
def delete_setting(module: AnsibleModule, client: AlmSettingsGitlabClient, key: str):
...
def build_requested_setting(params: dict) -> AlmSettingsGitlab:
...
def run_module(module: AnsibleModule, client: AlmSettingsGitlabClient):
...
def main():
    ...
    # Build Client from Module
    client = build_client(module).alm_settings_gitlab
